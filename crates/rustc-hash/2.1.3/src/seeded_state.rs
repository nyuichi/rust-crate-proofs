use crate::FxHasher;
use creusot_std::prelude::{ensures, logic, Invariant, View};
...
impl View for FxSeededState {
    type ViewTy = usize;

    /// The seed used for every hasher built by this state.
    #[logic]
...
impl Invariant for FxSeededState {
    #[logic(open)]

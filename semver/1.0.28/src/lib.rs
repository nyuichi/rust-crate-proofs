...
#[cfg_attr(not(creusot), derive(Clone, Eq, PartialEq, Ord, PartialOrd, Hash))]
pub struct Version {
    pub major: u64,
    pub minor: u64,
    pub patch: u64,
...
#[cfg_attr(not(creusot), derive(Clone, Eq, PartialEq, Hash, Debug))]
...
#[cfg_attr(not(creusot), derive(Copy, Clone, Eq, PartialEq, Hash, Debug))]
#[non_exhaustive]
pub enum Op {
    Exact,
    Greater,
...
#[cfg_attr(not(creusot), derive(Default, Clone, Eq, PartialEq, Hash))]
...
impl VersionReq {
    ...
    /// described by `self`.
    #[ensures(result == eval::matches_req_model(self, version))]
...
impl Comparator {
    ...
    #[ensures(result == (eval::matches_impl_model(self, version)
        && (eval::prerelease_is_empty_model(&version.pre)
            || eval::pre_is_compatible_model(self, version))))]
    pub fn matches(&self, version: &Version) -> bool {
...
impl Prerelease {
    ...
    #[trusted]
    #[ensures(result == eval::prerelease_is_empty_model(self))]

...
use creusot_std::prelude::{trusted, DeepModel};
...
pub trait Engine: Send + Sync {
    ...
    #[cfg(any(feature = "alloc", test))]
    #[inline]
    // Creusot boundary for generic/allocation adapters in this trait.
    // TODO: remove each trusted default after AsRef, Vec, and codec contracts exist.
    #[trusted]
...
pub struct DecodeMetadata {
    ...
    #[cfg(creusot)]
    pub padding_offset: Option<usize>,
}

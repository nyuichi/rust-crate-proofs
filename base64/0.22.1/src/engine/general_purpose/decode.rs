...
#[cfg(creusot)]
use crate::decode::decoded_len_estimate_model;
...
pub struct GeneralPurposeEstimate {
    ...
    #[cfg(creusot)]
    pub conservative_decoded_len: usize,
}

impl GeneralPurposeEstimate {
    #[ensures(result.rem@ == encoded_len@ % 4)]
    #[ensures(result.conservative_decoded_len@ == decoded_len_estimate_model(encoded_len@))]
...
impl DecodeEstimate for GeneralPurposeEstimate {
    #[ensures(result@ == self.conservative_decoded_len@)]
...
#[inline]
// Creusot boundary: optimized decode orchestration awaits chunk contracts.
// TODO: prove complete quads, then suffix composition.
#[trusted]
...
// Creusot boundary: TODO specify and prove the complete-quad partition length.
#[trusted]
...
#[inline(always)]
// Creusot boundary: TODO prove the exact eight-symbol/six-byte transformation.
#[trusted]
fn decode_chunk_8(
    input: &[u8],
...
#[inline(always)]
// Creusot boundary: TODO prove the exact four-symbol/three-byte transformation.
#[trusted]
fn decode_chunk_4(
    input: &[u8],
    index_at_start_of_input: usize,

...
#[cfg(all(not(creusot), feature = "alloc"))]
pub use crate::bstring::BString;
#[cfg(not(creusot))]
pub use crate::escape_bytes::EscapeBytes;
#[cfg(all(not(creusot), feature = "unicode"))]
...
mod verification;
#[cfg(creusot)]
pub use crate::verification::{first_non_ascii_byte, inv_memchr, inv_memrchr};
...
#[cfg(not(creusot))]
mod impls;
#[cfg(all(not(creusot), feature = "std"))]
pub mod io;
#[cfg(all(not(creusot), test, feature = "std"))]
mod tests;
#[cfg(all(not(creusot), feature = "unicode"))]
mod unicode;
#[cfg(not(creusot))]
